            ...
            <div class="row">
               ...
               <div class="col-md-4">
                  <form class="d-flex " role="search">
                     <input class="form-control " style="border-bottom-left-radius: 17px; border-top-left-radius: 17px; width:26rem; height:45px;" type="search" placeholder="Search" aria-label="Search" id="form-search">
                     <a href="#" id="bt-search"><img class="col-4" style="border-bottom-right-radius: 17px; border-top-right-radius: 17px; height:45px; width:50px;" src="{{ asset('img/logo/search.png') }}" alt="" srcset=""></a>
                  </form>
               </div>
               <div class="col-md-1">
                  <a id="btNetwork" class="btn btn-danger" href="https://radartasik.disway.id/network/list-network">Network</a>
               </div>
               <div class="col-md-4">
                  <div class="col-md-12">
                     <div class="col-md-10">
